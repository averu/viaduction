---
name: implement
description: TASK-XXX を 1 つ受け取り、implementer Subagent に実装させる。TASK-ID 必須。指定が無ければ何もせず終了する。Phase 6 の入口。
argument-hint: "TASK-XXX"
---

# implement

Phase 6（実装）の入口 Skill。指定された **1 つの TASK-XXX のみ** を `implementer` Subagent に実装させる。

## いつ使うか

- 設計・タスク分解が完了し、特定の TASK を実装したいとき
- ユーザが「TASK-001 を実装して」と言ったとき
